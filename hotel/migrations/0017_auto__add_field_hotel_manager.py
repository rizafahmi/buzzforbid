...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hotel_hotel', 'manager',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=' ', related_name='manager_user', unique=True, to=orm['user_level.Manager']),
                      keep_default=False)
    ...
    models = {
        ...
        'hotel.hotel': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'manager_user'", 'unique': 'True', 'to': "orm['user_level.Manager']"}),
