...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hotel_hotel', (
            ...
            ('room_type_1', self.gf('django.db.models.fields.related.OneToOneField')(related_name='hotel_room_type_1', unique=True, to=orm['hotel.RoomType'])),
    ...
    models = {
        ...
        'hotel.hotel': {
            ...
            'room_type_1': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'hotel_room_type_1'", 'unique': 'True', 'to': "orm['hotel.RoomType']"}),
