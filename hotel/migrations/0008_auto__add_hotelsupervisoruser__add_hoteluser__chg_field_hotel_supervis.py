...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hotel.user'
        db.alter_column('hotel_hotel', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['hotel.HotelUser']))
    def backwards(self, orm):
        ...
        # Changing field 'Hotel.supervisor'
        db.alter_column('hotel_hotel', 'supervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Hotel.user'
        db.alter_column('hotel_hotel', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    models = {
        'auth.group': {
        ...
        'hotel.hotel': {
            ...
            'cs_email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
