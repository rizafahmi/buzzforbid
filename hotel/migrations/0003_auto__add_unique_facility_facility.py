...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Facility', fields ['facility']
        db.create_unique('hotel_facility', ['facility'])

    def backwards(self, orm):
        # Removing unique constraint on 'Facility', fields ['facility']
        db.delete_unique('hotel_facility', ['facility'])
