...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hotel.cs_email'
        db.alter_column('hotel_hotel', 'cs_email', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True, null=True))
    def backwards(self, orm):

        # Changing field 'Hotel.cs_email'
        db.alter_column('hotel_hotel', 'cs_email', self.gf('django.db.models.fields.EmailField')(default=' ', max_length=75, unique=True))
    models = {
        'auth.group': {
