...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('hotel_hotel', 'manager_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['user_level.Manager']))
        # Adding unique constraint on 'Hotel', fields ['manager']
        db.create_unique('hotel_hotel', ['manager_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Hotel', fields ['manager']
        db.delete_unique('hotel_hotel', ['manager_id'])
