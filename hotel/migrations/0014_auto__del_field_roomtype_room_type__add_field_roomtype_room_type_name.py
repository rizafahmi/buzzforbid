...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RoomType.room_type'
        db.delete_column('hotel_roomtype', 'room_type')

        # Adding field 'RoomType.room_type_name'
        db.add_column('hotel_roomtype', 'room_type_name',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=50),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'RoomType.room_type'
        db.add_column('hotel_roomtype', 'room_type',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=50),
                      keep_default=False)

        # Deleting field 'RoomType.room_type_name'
        db.delete_column('hotel_roomtype', 'room_type_name')
