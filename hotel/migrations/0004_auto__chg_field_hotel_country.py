...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hotel.country'
        db.alter_column('hotel_hotel', 'country', self.gf('django.db.models.fields.CharField')(max_length=35))
    def backwards(self, orm):

        # Changing field 'Hotel.country'
        db.alter_column('hotel_hotel', 'country', self.gf('django.db.models.fields.CharField')(max_length=50))
    models = {
        'city.city': {
