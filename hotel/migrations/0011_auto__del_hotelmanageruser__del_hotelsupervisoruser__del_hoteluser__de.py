...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'HotelManagerUser'
        db.delete_table('hotel_hotelmanageruser')

        # Deleting model 'HotelSupervisorUser'
        db.delete_table('hotel_hotelsupervisoruser')

        # Deleting model 'HotelUser'
        db.delete_table('hotel_hoteluser')
        ...
        db.add_column('hotel_hotel', 'receptionist',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='receptionist_user', null=True, to=orm['user_level.Receptionist']),
                      keep_default=False)


        # Changing field 'Hotel.supervisor'
        db.alter_column('hotel_hotel', 'supervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['user_level.Supervisor']))

        # Changing field 'Hotel.manager'
        db.alter_column('hotel_hotel', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['user_level.Manager']))
    def backwards(self, orm):
        # Adding model 'HotelManagerUser'
        db.create_table('hotel_hotelmanageruser', (
        ...
        db.send_create_signal('hotel', ['HotelManagerUser'])

        # Adding model 'HotelSupervisorUser'
        db.create_table('hotel_hotelsupervisoruser', (
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('hotel', ['HotelSupervisorUser'])

        # Adding model 'HotelUser'
        db.create_table('hotel_hoteluser', (
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('hotel', ['HotelUser'])

        # Adding field 'Hotel.user'
        db.add_column('hotel_hotel', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_user', null=True, to=orm['hotel.HotelUser'], blank=True),
                      keep_default=False)
        ...
        # Changing field 'Hotel.supervisor'
        db.alter_column('hotel_hotel', 'supervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['hotel.HotelSupervisorUser']))

        # Changing field 'Hotel.manager'
        db.alter_column('hotel_hotel', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['hotel.HotelManagerUser']))
    models = {
        'auth.group': {
