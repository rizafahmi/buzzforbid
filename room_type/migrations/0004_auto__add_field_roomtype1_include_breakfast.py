...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoomType1.include_breakfast'
        db.add_column('room_type_roomtype1', 'include_breakfast',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RoomType1.include_breakfast'
        db.delete_column('room_type_roomtype1', 'include_breakfast')
