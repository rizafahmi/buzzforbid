...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.attachment'
        db.add_column('tour_request_request', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Request.notes'
        db.add_column('tour_request_request', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Request.attachment'
        db.delete_column('tour_request_request', 'attachment')

        # Deleting field 'Request.notes'
        db.delete_column('tour_request_request', 'notes')
