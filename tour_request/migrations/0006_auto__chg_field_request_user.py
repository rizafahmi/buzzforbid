...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tour_request_request', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    def backwards(self, orm):

        # Changing field 'Request.user'
        db.alter_column('tour_request_request', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['auth.User']))
    models = {
        'auth.group': {
        ...
        'tour_request.request': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'request_user'", 'null': 'True', 'to': "orm['auth.User']"})
        }
    }
