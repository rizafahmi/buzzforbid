...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('user_level', ['Manager'])
        ...
        db.send_create_signal('user_level', ['Supervisor'])
        ...
        db.send_create_signal('user_level', ['Receptionist'])

    def backwards(self, orm):
        # Deleting model 'Manager'
        db.delete_table('user_level_manager')

        # Deleting model 'Supervisor'
        db.delete_table('user_level_supervisor')

        # Deleting model 'Receptionist'
        db.delete_table('user_level_receptionist')
